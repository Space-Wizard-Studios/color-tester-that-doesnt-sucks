...
const ContrastChecker: React.FC = () => {
  ...
  return (
    <main className="min-h-screen flex flex-row bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto p-6 w-full md:max-w-3/4">
      ...
      <div className="hidden md:block w-full md:max-w-1/4 border-l border-gray-200 bg-white overflow-y-auto">
